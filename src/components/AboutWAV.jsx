            ...
            <div className="about-wav-content-container">
                <div className="about-wav-demon-container">
                    ...
                    <div className="about-wav-text-container">
                        ...
                        <p>IT IS A COLLABORATIVE PLATFORM BORN FROM THE JOINING OF THE VISION OF A COLLECTIVE OF ARTISTIC DIRECTORS INCLUDING Sophia Brinkgerd, Philipp Bulk, Jonas Fürste, Leonhard Laupichler AND ALBERTO DEON, WITH THE LATER BEING THE METAPHORIC AND ACTUAL VOICE OF THE PROJECT.</p>
